                        ...
                        <div class="good-item">
                            ...
                            <div class="good-desc">
                                ...
                                <div class="good-btn">
                                    ...
                                    <van-stepper :min="1" :max="item.goods.stock" :model-value="item.num" :name="item.id" @change="onChange" async-change/>
                                </div>
                            </div>
                        </div>
                        <template #right>
...
export default {
    ...
    setup() {
        ...
        const groupChange = (result) => {
            ...
            state.result = result;
            //改变（更新）数据表中的复选框选中状态
            checkedCartshopping({cart_ids: result});
        }
